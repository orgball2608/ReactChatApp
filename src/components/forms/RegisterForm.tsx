        ...
        <>
            <form className="w-[800px]" onSubmit={handleSubmit(FormSubmit)}>
                <div className="bg-simple-gray py-3 px-4 rounded-[10px] w-full border-box">
                    <label htmlFor="email" className="block text-label-white text-[14px] px-[14px]">
                        Email
                    </label>
                    <input
                        type="email"
                ...
                <section className="w-full flex justify-between my-2 gap-2">
                    <div className="bg-simple-gray py-3 px-4 rounded-[10px] w-full border-box">
                        <label htmlFor="firstName" className="block text-label-white text-[14px] px-[14px]">
                            First Name
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="bg-simple-gray py-3 px-4 rounded-[10px] w-full border-box">
                        <label htmlFor="lastName" className="block text-label-white text-[14px] px-[14px]">
                            Last Name
                        </label>
                        <input
                            type="text"
                ...
                <div className="bg-simple-gray py-3 px-4 rounded-[10px] w-full border-box">
                    <label htmlFor="password" className="block text-label-white text-[14px] px-[14px]">
                        Password
                    </label>
                    <input
                        type="password"
