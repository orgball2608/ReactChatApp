...
export const AddNewFriendModal: FC<Props> = ({  setShowModal }) => {
    ...
    return (
        <>
            ...
            >
                <div className="bg-modal-background w-screen max-w-[550px] box-border rounded-lg  overflow-hidden h-fit min-w-screen flex flex-col gap-4 animate-fade-in">
                    <div className=" box-border flex justify-center flex-shrink-0 items-center px-4 py-4 border-b-[1px] border-border-conversations ">
                        ...
                        <span className="text-2xl">Add Friend</span>
