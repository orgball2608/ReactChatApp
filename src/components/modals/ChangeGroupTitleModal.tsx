        ...
        >
            <div className="bg-modal-background w-screen max-w-[550px] box-border rounded-lg  overflow-hidden h-fit min-w-screen flex flex-col gap-4">
                <div className=" box-border flex justify-center flex-shrink-0 items-center px-4 py-3 border-b-[1px] border-border-conversations ">
                    ...
                    <span className="text-lg font-medium leading-5">Change Group Title</span>
                ...
                <div className="px-6 pb-4 pt-2">
                    <span className='text-sm font-light'>Mọi người đều biết khi tên nhóm chat thay đổi.</span>
                    <div className="w-full flex justify-center flex-col relative gap-2">
                        <section className="my-3">
                            <div className="bg-conversation-form py-3 px-4 rounded-xl w-full border-box">
                                ...
                                <input
                                    ...
                                    className="text-base font-normal w-full border-box p-0 text-white bg-inherit border-0 outline-0 scrollbar-hide overflow-auto resize-none"
                                />
                            </div>
                        </section>
                        <div className="flex w-full gap-2 justify-center items-center">
                            <button
                                ...
                                className=" w-1/2 outline-0 border-0 text-base hover:bg-[#1c1e20] text-white rounded-xl py-2 mt-1 transform active:scale-125 transition-all duration-300"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="w-1/2 outline-0 border-0 text-base bg-[#125a9d] text-white rounded-xl py-2 mt-1 disabled:opacity-50 transform active:scale-125 transition-all duration-300"
                            >
                                Save
                            </button>
                        </div>
