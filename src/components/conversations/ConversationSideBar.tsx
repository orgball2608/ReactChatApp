...
export const ConversationSidebar: FC<Props> = ({conversations}) => {
    return (
        <aside className="position: absolute top-0 left-0 h-full w-[400px] bg-dark-light border-r-[1px] border-solid border-border-conversations overflow-y-scroll scrollbar-hide overflow-auto">
            <header className="position:fixed top-0 left-0 w-[400px] flex justify-between items-center px-8 bg-dark-header h-[80px] border-bottom-[1px] border-border-conversations border-solid">
